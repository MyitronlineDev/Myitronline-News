...
const categoryColors = {
  ...
  const categoryColor = categoryColors[currentCategory] || categoryColors.Default;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className={`relative overflow-hidden bg-gradient-to-r ${categoryColor} text-white rounded-2xl shadow-2xl mb-12`}>
          ...
          <div className="relative p-8 md:p-10">
            ...
            <p className="text-lg text-white/80 max-w-2xl">
              Official {currentCategory.toLowerCase()} circulars, notifications, and regulatory updates
            </p>
            
            <div className="flex items-center gap-2 mt-6 text-sm text-white/60">
              <FiAlertCircle />
              <span>Updated in real-time • Official sources • Verified documents</span>
            </div>
          </div>
        </div>
        {/* CIRCULARS GRID */}
        {data?.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-700 mb-2">No circulars found</h3>
            <p className="text-gray-500 max-w-md mx-auto">
              There are currently no {currentCategory.toLowerCase()} circulars available. Check back later for updates.
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
            {data.map((item, index) => (
              ...
              >
                <div className={`h-2 ${index === 0 ? 'bg-gradient-to-r from-blue-500 to-purple-500' : 'bg-gradient-to-r from-gray-300 to-gray-400'}`}></div>
                ...
                <div className="p-6 md:p-8">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    <div className="flex items-center gap-2 text-sm text-gray-500">
                      <span className="text-xs px-2 py-1 bg-gray-100 rounded">Official</span>
                      <span>•</span>
                    ...
                    <div className="flex gap-3">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-medium hover:from-blue-700 hover:to-blue-800 transition-all group/btn"
                      >
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-gray-800 mb-1">About these circulars</h4>
              <p className="text-gray-600 text-sm">
                These are official {currentCategory.toLowerCase()} circulars published by regulatory authorities. 
                Always refer to the original PDF documents for legal purposes. 
                This page is updated automatically as new circulars are published.
              </p>
            </div>
          </div>
        </div>
