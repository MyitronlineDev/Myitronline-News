      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-10 py-10">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-8">
          ...
          <div className="flex flex-col gap-4">
            <div className="leading-tight">
              ...
              {/* Tagline */}
              <div className="mt-3 text-xs text-gray-400 flex flex-wrap items-center gap-3">
                <span>Honest</span>
        ...
        <div className="mt-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <p className="text-sm text-gray-300 leading-relaxed max-w-3xl">
            ...
            <span className="font-semibold text-white">Renaz</span> content
            ...
            {[
              {
                ...
                label: "Facebook",
                path:
                  "M22 12a10 10 0 10-11.5 9.9v-7H8v-3h2.5V9.5c0-2.5 1.5-3.9 3.8-3.9 1.1 0 2.2.2 2.2.2v2.4h-1.2c-1.2 0-1.6.8-1.6 1.6V12H18l-.4 3h-2.9v7A10 10 0 0022 12z",
              },
              {
                href: "https://in.linkedin.com/",
                label: "LinkedIn",
                path:
                  "M4.98 3.5A2.5 2.5 0 112.5 6a2.5 2.5 0 012.48-2.5zM3 8.98h4v12H3v-12zM9 8.98h3.8v1.7h.05c.53-1 1.82-2.06 3.75-2.06 4.01 0 4.75 2.64 4.75 6.07v6.29h-4v-5.57c0-1.33-.02-3.04-1.86-3.04-1.87 0-2.16 1.46-2.16 2.95v5.66H9v-12z",
              },
              {
                href: "https://www.instagram.com/",
                label: "Instagram",
                path:
                  "M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5zm5 5.5A4.5 4.5 0 1016.5 12 4.5 4.5 0 0012 7.5zm6.5-.9a1.1 1.1 0 11-1.1-1.1 1.1 1.1 0 011.1 1.1z",
              },
              {
                href: "https://x.com/?lang=en-in",
                label: "X / Twitter",
                path:
                  "M22 4.01c-.77.35-1.6.58-2.46.69a4.27 4.27 0 001.88-2.36 8.64 8.64 0 01-2.72 1.04 4.26 4.26 0 00-7.3 3.88 12.09 12.09 0 01-8.8-4.46 4.26 4.26 0 001.32 5.68 4.24 4.24 0 01-1.93-.54v.05a4.26 4.26 0 003.42 4.18 4.32 4.32 0 01-1.92.07 4.27 4.27 0 003.98 2.96 8.54 8.54 0 01-5.29 1.82c-.34 0-.68-.02-1.02-.06a12.08 12.08 0 006.56 1.92c7.88 0 12.2-6.53 12.2-12.2 0-.19-.01-.39-.02-.58A8.72 8.72 0 0022 4.01z",
              },
            ].map(({ href, label, path }) => (
              <a
                key={label}
